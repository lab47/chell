...
func (s *ScriptLoad) loadDir(dir, name string) (ScriptData, error) {
	var short string
...
func (s *ScriptLoad) loadGithub(client httpDo, repo, name string) (ScriptData, error) {
...
func (s *ScriptLoad) Load(name string) (ScriptData, error) {
...
func (s *ScriptLoad) loadGeneric(p, name string) (ScriptData, error) {
	switch {
...
func (s *ScriptLoad) loadVanity(client httpDo, repo, name string) (ScriptData, error) {
